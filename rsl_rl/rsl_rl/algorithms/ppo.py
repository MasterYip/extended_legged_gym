...
from rsl_rl.modules import ActorCritic, ActorCriticRecurrent, RandomNetworkDistillation
...
class PPO:
    ...
    policy: Union[ActorCritic, ActorCriticRecurrent]
    ...
    def init_storage(self, *args, aux_obs_shape=None):
        ...
        if len(args) == 5:
            ...
            num_envs, num_transitions_per_env, actor_obs_shape, critic_obs_shape, actions_shape = args
            training_type = "rl"  # Default to RL for old interface
        elif len(args) == 6:
            # New interface: init_storage(training_type, num_envs, num_transitions_per_env, actor_obs_shape, critic_obs_shape, actions_shape)
            training_type, num_envs, num_transitions_per_env, actor_obs_shape, critic_obs_shape, actions_shape = args
        else:
            raise ValueError(f"Invalid number of arguments for init_storage: {len(args)}")
